      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <ol className="list-inside list-decimal text-sm text-center sm:text-left">
          <li className="mb-2">
            ...
            <code className="bg-foreground/[.05] dark:bg-foreground/[.06] px-1 py-0.5 rounded">
              app/page.tsx
            </code>
            .
          </li>
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          ...
          <a
            className="rounded-full border border-solid border-foreground/[.08] dark:border-foreground/[.145] transition-colors flex items-center justify-center hover:bg-foreground/[.05] dark:hover:bg-foreground/[.06] hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:min-w-44"
